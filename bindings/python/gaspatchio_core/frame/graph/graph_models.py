...
class NodeData(BaseModel):
    ...
    source_location: str | None = Field(default=None, description="Source code location")
    value_sample: Any | None = Field(default=None, description="Sample value from data")
    trace: list[dict[str, Any]] | None = Field(default=None, description="Calculation trace")
...
class GraphExportConfig(BaseModel):
    ...
    policy_id: str | None = Field(default=None, description="Policy ID for sample values")
    policy_id_column: str = Field(default="Policy number", description="Name of policy ID column")
    filter_expr: str | None = Field(default=None, description="Polars filter expression")
