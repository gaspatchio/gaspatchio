...
```bash
uv run python \
    bindings/python/gaspatchio/tutorials/patterns/curves-and-scheduling/01_curve_construction.py
```
...
were promoted to `gaspatchio`:

```python
from gaspatchio import ActuarialFrame, Curve, Schedule, ActualActualISDA, OneTwelfth
```
