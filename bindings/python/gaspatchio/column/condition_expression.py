...
from gaspatchio.column.shape import _UNSET, Shape, _max_shape, resolve_shape
...
class ConditionExpression:
    ...
    def _has_list_column(self, expr: pl.Expr) -> bool:
        ...
        from gaspatchio.column.shape import _shape_from_expr_dtype
    ...
    def _to_boolean_expr(self) -> pl.Expr:
        ...
        """
        from gaspatchio.polars_backend.masks import to_boolean_expr
    ...
    def __and__(self, other: ConditionExpression) -> ExpressionProxy:
        ...
        """
        from gaspatchio.column.expression_proxy import ExpressionProxy
        from gaspatchio.polars_backend.masks import boolean_and
    ...
    def __or__(self, other: ConditionExpression) -> ExpressionProxy:
        ...
        """
        from gaspatchio.column.expression_proxy import ExpressionProxy
        from gaspatchio.polars_backend.masks import boolean_or
    ...
    def __invert__(self) -> ExpressionProxy:
        ...
        from gaspatchio.column.expression_proxy import ExpressionProxy
        from gaspatchio.polars_backend.masks import boolean_not
