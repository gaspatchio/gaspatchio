...
def find_user_code_frame(start_frame: Any | None = None) -> inspect.FrameInfo | None:
...
def get_source_location(frame: Any, capture_multiline: bool = True) -> SourceLocation | None:
...
def find_calling_user_code() -> tuple[SourceLocation | None, Any | None]:
