...
:class:`gaspatchio.assumptions.Table`. It does not duplicate Table's
...
from gaspatchio.mortality._conventions import (
    validate_age_basis,
    ...
    def _at_select_ultimate(
        ...
        **other: pl.Expr,
        ...
        if hasattr(duration, "_to_expr"):
            ...
            from gaspatchio.polars_backend.plugins import list_clip
