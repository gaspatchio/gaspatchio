...
from gaspatchio._identity import canonical_bytes
from gaspatchio.curves._interpolation import (
    hermite_eval,
    linear_interpolate,
    log_df_knots,
    log_linear_spot,
...
from gaspatchio.curves._smith_wilson import calibrate_alpha, solve_zeta, sw_spot
from gaspatchio.curves._svensson import fit_svensson, svensson_spot
from gaspatchio.schedule._day_count import ActualActualISDA, DayCount
...
class Curve:
    ...
    def fit_svensson(
        ...
        *,
        ...
        :func:`~gaspatchio.curves._svensson.svensson_spot_cc`.
    ...
    def fit_smith_wilson(
        ...
        *,
        ...
        :mod:`~gaspatchio.curves._smith_wilson`) for the Wilson weights
    ...
    def discount_factor(
        ...
        if isinstance(t, pl.Expr):
            from gaspatchio.functions.vector import curve_eval, list_pow
    ...
    def key_rate_shift(self, *, tenor: float, bps: float) -> Curve:
        ...
        """
        from gaspatchio.curves._shift import key_rate_shift
    ...
    def from_par_rates(
        ...
        *,
        ...
        """
        from gaspatchio.curves._bootstrap import par_to_zero_rates
    ...
    def shift_parallel(self, *, bps: float) -> Curve:
        ...
        """
        from gaspatchio.curves._shift import shift_parallel
    ...
    def source_sha(self) -> str:
        ...
        :func:`gaspatchio._identity.canonical_bytes` (sorted
