...
from gaspatchio.scenarios._auto_batch import (
    _SAFETY_CEILING,
    memory_budget_bytes,
    process_rss_bytes,
)
...
def _reraise_with_attribution(af: ActuarialFrame, error: Exception) -> NoReturn:
    ...
    """
    from gaspatchio.errors import _handle_execution_error
...
def _write_batch_parquet(frame: pl.DataFrame, path: Path) -> None:
    ...
    from gaspatchio.scenarios._spill import safe_write_parquet
