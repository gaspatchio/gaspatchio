...
if TYPE_CHECKING:
    ...
    from gaspatchio.scenarios._for_each import BatchSnapshot
...
class ScenarioRun:
    ...
    def _write_audit_sidecar(
        ...
        *,
        ...
        import gaspatchio
        from gaspatchio.scenarios._audit import write_audit
        ...
        write_audit(
            ...
            run_metadata={
                ...
                "library_version": getattr(gaspatchio, "__version__", "unknown"),
