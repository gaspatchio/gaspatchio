...
def get_linting_suggestion(
    ...
    """
    if error_code == "E401" or "Multiple imports on one line" in error_message:
        return {
            "error_code": "E401",
    ...
    if error_code == "F401" or "imported but unused" in error_message:
        return {
            "error_code": "F401",
            "title": "Unused import",
    ...
    if error_code == "F821" or "Undefined name" in error_message:
        return {
            "error_code": "F821",
    ...
    if error_code == "E501" or "Line too long" in error_message:
        return {
            "error_code": "E501",
            "title": "Line too long",
    ...
    if error_code == "W292" or "No newline at end of file" in error_message:
        return {
            "error_code": "W292",
    ...
    if error_code == "F841" or (
        "local variable" in error_message
    ...
    if error_code == "E722" or "Do not use bare except" in error_message:
        return {
            "error_code": "E722",
            "title": "Bare except",
